                ...
                <div className="blockSocial">
                    <div className="socialSlides Event">
                        <div className="socialSlidesContent">
                            <h3><b>{titre1}</b></h3>
                            <Bouton href={"le-social#evenements"}>{boutonTexte1}</Bouton>
                        </div>
                    ...
                    <div className="socialSlides Communaute">
                        <div className="socialSlidesContent">
                            <h3><b>{titre2}</b></h3>
                            <Bouton href={"le-social#communaute"}>{boutonTexte2}</Bouton>
                        </div>
                        <div className="clipPath"></div>
                    </div>
                    <div className="socialSlides Maisonneuve">
                        <div className="socialSlidesContent">
                            <h3><b>{titre3}</b></h3>
                            <Bouton href={"le-social#maisonneuve"}>{boutonTexte3}</Bouton>
                        </div>
                        <div className="clipPath"></div>
                    </div>
                </div>
